...
import curso.java.classes.Secretario3;
...
public class Principal18 {
	...
	public static void main(String[] args) {
		...
		if(new Secretario3().autenticar(login, senha)) {
		...
		//		aluno1.setNomeEscola(escola);
			...
			for (Aluno aluno : maps.get(StatusAluno.APROVADO)) {
				System.out.println("Aluno: " + aluno.getNome() + ", Resultado: "+ aluno.getAlunoAprovado2() + " com Média de: " + aluno.getMediaNotas());
			}
